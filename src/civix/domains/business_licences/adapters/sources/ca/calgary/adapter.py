...
Fetches Calgary's Socrata SODA "Calgary Business Licenses" dataset via
the shared Socrata source adapter. Socrata-computed region fields are
stripped before records enter Civix snapshots.
"""
...
_SOURCE_RECORD_ID_FIELD: Final[str] = "getbusid"


@dataclass(frozen=True, slots=True)
class CalgaryBusinessLicencesAdapter:
    """Fetches Calgary's business-licences dataset via the shared Socrata adapter."""
