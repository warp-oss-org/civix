"""Chicago Traffic Crashes - People source adapter."""
...
CHICAGO_PEOPLE_DATASET_ID: Final[DatasetId] = DatasetId("u6pd-qa9d")
...
_SOURCE_RECORD_ID_FIELD: Final[str] = "person_id"

CHICAGO_PEOPLE_DATASET_CONFIG: Final[SocrataDatasetConfig] = SocrataDatasetConfig(
    source_id=SOURCE_ID,
...
class ChicagoPeopleAdapter:
    """Fetches Chicago crash person rows via the shared Socrata adapter."""

    fetch_config: SocrataFetchConfig

    @property
    def source_id(self) -> SourceId:
        return CHICAGO_PEOPLE_DATASET_CONFIG.source_id

    @property
    def dataset_id(self) -> DatasetId:
        return CHICAGO_PEOPLE_DATASET_CONFIG.dataset_id

    @property
    def jurisdiction(self) -> Jurisdiction:
        return CHICAGO_PEOPLE_DATASET_CONFIG.jurisdiction
