...
class NycCrashesAdapter:
    """Fetches NYC crash rows via the shared Socrata adapter."""

    fetch_config: SocrataFetchConfig

    @property
    def source_id(self) -> SourceId:
        return NYC_CRASHES_DATASET_CONFIG.source_id

    @property
    def dataset_id(self) -> DatasetId:
        return NYC_CRASHES_DATASET_CONFIG.dataset_id

    @property
    def jurisdiction(self) -> Jurisdiction:
        return NYC_CRASHES_DATASET_CONFIG.jurisdiction
